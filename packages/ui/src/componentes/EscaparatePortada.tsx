          ...
          <div className="ui-escaparate__promocion-asistente">
            ...
            <section className="ui-escaparate__asistente" aria-label="Beneficios de compra">
              <div className="ui-escaparate__asistente-opciones">
                <div><IconoBeneficio nombre="security" /><span><strong>Seguridad</strong></span></div>
                <div><IconoBeneficio nombre="box-time" /><span><strong>Envíos</strong></span></div>
                <div><IconoBeneficio nombre="verify" /><span><strong>Garantía</strong></span></div>
                <div><IconoBeneficio nombre="message-text" /><span><strong>Soporte</strong></span></div>
              </div>
            </section>
          </div>
        </div>
